...
export const DEFAULT_ROLE_PERMISSIONS = {
    Administrator: [
        ...
        'audit_logs.access', 'audit_logs.view_activity', 'audit_logs.view_permission_changes', 'audit_logs.view_hr_manual_bookings', 'audit_logs.view_seat_reservations', 'audit_logs.view_email_log', 'audit_logs.view_hod_seat_assignments', 'audit_logs.view_ferry_transfers', 'audit_logs.view_resort_capacity', 'audit_logs.view_ferry_services', 'audit_logs.view_supplier_reservations',
    ],
    'General Manager': [
    ...
    'Resident Manager': [
        ...
        'approval_workflow.access', 'approval_workflow.view_history',
        'approval_workflow.manage_own_availability', 'approval_workflow.executive_override',
        'booking.access', 'booking.bulk_transfer_passengers', 'booking.view_resort_capacity', 'booking.manage_supplier_reservations',
        'reports.access', 'reports.view_manager',
    ],
    'HR Manager': [
        'dashboard.access', 'dashboard.view_manager',
